...
namespace RainMaker
{
    public class MethodCalling
    {
        ...
        clsDBAccess objMLTNT = new clsDBAccess("Password=MsGP@197;Persist Security Info=True;User ID=msgp.admin;Initial Catalog=MLTNT;Data Source=202.141.239.197", DBEngineType.SQL);
        ...
        DataTable dt_CR;
        DataTable dt_CSRFO;
        DataTable dt_C30Days;
        DataTable dt_C3CircuitCom;
        //------Smart Search---------
        DataTable dt_RI;
        DataTable dt_RR;
        ...
        public DataTable GetCircuitStatsHitting3Comp()
        {
            try
            {
                if (dt_C3CircuitCom == null)
                {
                    dt_C3CircuitCom = new DataTable();
                }

                dt_C3CircuitCom = objBSS.SP_Datatable("sp_Dash_GetCircuitStatsHitting3Comp");
                dt_C3CircuitCom.TableName = "sp_Dash_GetCircuitStatsHitting3Comp";
                return dt_C3CircuitCom;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable GetCompDetailsOnLabelClick(int RegionID, string AgingFlag, int AssginDepartID,int SignupID)
        {
            try
            {
                if (dt_COL == null)
        ...
        public DataTable Getlast30DaysComplains(String CurrDate)
        {
            ...
            try
            {
                ...
                dt_C30Days = objBSS.SP_Datatable("sp_Dash_Getlast30DaysComplainss", para);
                dt_C30Days.TableName = "sp_Dash_Getlast30DaysComplainss";
                return dt_C30Days;
        ...
        public DataTable GetRevenueMonthWiseLOB()
        {
            try
            {
                if (dt_RR == null)
                ...
                dt_RR = objMLTNT.SP_Datatable("sp_Dash_RevenueMonthWiseLOB");
                dt_RR.TableName = "sp_Dash_RevenueMonthWiseLOB";
                return dt_RR;
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetRevenueCountMonthGreater3()
        {
            try
            {
                if (dt_RRCount3 == null)
                {
                    dt_RRCount3 = new DataTable();
                }


                dt_RRCount3 = objMLTNT.SP_Datatable("sp_Dash_RevenueCountMonthGreat&Equal3Month");
                dt_RRCount3.TableName = "sp_Dash_RevenueCountMonthGreat&Equal3Month";
                return dt_RRCount3;
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetReceiptmonthwise()
        {
            try
            {
                if (dt_RRecipt == null)
                {
                    dt_RRecipt = new DataTable();
                }


                dt_RRecipt = objMLTNT.SP_Datatable("sp_Dash_Receiptmonthwise");
                dt_RRecipt.TableName = "sp_Dash_Receiptmonthwise";
                return dt_RRecipt;
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetSalesTaxmonthwiseLOB()
        {
            try
            {
                if (dt_RSales == null)
                {
                    dt_RSales = new DataTable();
                }


                dt_RSales = objMLTNT.SP_Datatable("sp_Dash_SalesTaxmonthwiseLOB");
                dt_RSales.TableName = "sp_Dash_SalesTaxmonthwiseLOB";
                return dt_RSales;
            }
            catch (Exception ex)
            {
