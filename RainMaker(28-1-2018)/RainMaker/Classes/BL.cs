    ...
    public partial class BL
    {
        ...
        public void loadSwitchPortCapacity(DropDownList DDSwitchPortCapacity)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    DataRow dr = dt.NewRow();
                    dr[0] = 0;
                    dr[1] = "Select SwitchPortCapacity";
                    dt.Rows.InsertAt(dr, 0);
        ...
        public void CreateDynamicRadioButton(string OptionType, Panel panel)
        {
            try
            {
                ...
                RadioButton[] radioButtons = new RadioButton[dt.Rows.Count];
                rb.RepeatDirection=RepeatDirection.Horizontal;
                if (dt.Rows.Count != 0)
                {
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        ...
                        radioButtons[i].GroupName = OptionType;
                        radioButtons[i].CssClass = "radio-button-div";
            ...
            try
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        ...
                        radioButtons[i].GroupName = OptionType;
                        radioButtons[i].CssClass = "radio-spacing";
                        panel.Controls.Add(radioButtons[i]);
